...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      className={cn("p-3 rounded-lg border border-border bg-card shadow-md", className)}
      classNames={{
        ...
        nav_button: cn(
          ...
          "h-7 w-7 bg-transparent p-0 opacity-50 hover:opacity-100 shadow-sm hover:shadow-md transition-all"
        ),
        ...
        day: cn(
          ...
          "h-9 w-9 p-0 font-normal aria-selected:opacity-100 hover:shadow-sm transition-all"
        ),
